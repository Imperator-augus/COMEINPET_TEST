<header id="header">
    <a href="<?php echo PH_DIR; ?>/manage/" class="logo">
        <h1><img src="<?php echo PH_MNG_DIR; ?>/images/logo.svg" alt="zigger Manager"></h1>
    </a>
    <ul id="tnb">
        ...
        <div id="gnb">
            ...
            <ul class="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo PH_MANAGE_DIR; ?>/member/result" data-idx-href="<?php echo PH_MANAGE_DIR; ?>/member/modify">가입 회원 관리</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo PH_MANAGE_DIR; ?>/popup/result" data-idx-href="<?php echo PH_MANAGE_DIR; ?>/popup/modify">생성된 팝업</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo PH_MANAGE_DIR; ?>/banner/result" data-idx-href="<?php echo PH_MANAGE_DIR; ?>/banner/modify">생성된 배너</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo PH_MANAGE_DIR; ?>/mailler/template" data-idx-href="<?php echo PH_MANAGE_DIR; ?>/mailler/regist|<?php echo PH_MANAGE_DIR; ?>/mailler/modify">메일 템플릿 관리</a>
                        </li>
                        <li><a href="<?php echo PH_MANAGE_DIR; ?>/mailler/send">회원 메일 발송</a></li>
                        <li>
                            <a href="<?php echo PH_MANAGE_DIR; ?>/mailler/history" data-idx-href="<?php echo PH_MANAGE_DIR; ?>/mailler/historyview">메일 발송 내역</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo PH_MANAGE_DIR; ?>/sms/history" data-idx-href="<?php echo PH_MANAGE_DIR; ?>/sms/historyview">SMS 발송 내역</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                ?>
                    <li>
                        ...
                        <ul>
                            ...
                            ?>
                                    <li>
                                        <a href="<?php echo PH_MANAGE_DIR . "/mod/" . $gnb_arr[$key]['mod'] . "/" . $gnb_arr[$key][$key2]['href']; ?>" <?php
