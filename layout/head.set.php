...
<head>
    ...
    <?php if (PH_THEME_DIR == "/comeinpet/theme/zigger-comeinpet") { ?>
        <link rel="stylesheet" href="<?php echo PH_THEME_DIR; ?>/layout/css/pet.css<?php echo SET_CACHE_HASH; ?>" />
        <link rel="stylesheet" href="<?php echo PH_THEME_DIR; ?>/layout/css/font.css<?php echo SET_CACHE_HASH; ?>" />
    <?php } ?>
    <?php
    // 모듈별 CSS
